      ...
      <ScrollView contentContainerStyle={styles.Content}>
        <View style={styles.Section}>
          ...
          <View style={styles.StatContainer}>
            <TouchableOpacity
              onPress={() =>
                navigator.navigate("Administration", { target: "Users" })
              }
            >
              <NumberStat
                number={usersCount}
            ...
            <TouchableOpacity
              onPress={() =>
                navigation.navigate("Administration", { target: "Kofal" })
              }
            >
              <NumberStat
                number={Mohsins}
        ...
        <View style={styles.Section}>
          ...
          <View style={styles.StatContainer}>
            <TouchableOpacity
              onPress={() =>
                navigation.navigate("Administration", { target: "Orphans" })
              }
            >
              <NumberStat
                number={orphans}
          ...
          <View style={styles.StatContainer}>
            <TouchableOpacity
              onPress={() =>
                navigation.navigate("Administration", { target: "Famillies" })
              }
            >
              <NumberStat
                number={FamilyNumber}
        ...
        <View style={styles.Section}>
          ...
          <TouchableOpacity
              onPress={() =>
                navigation.navigate("EducationSection", { target: "EducationOrphans" })
              }
            >
            ...
            <NumberStat
              ...
              <TouchableOpacity
              onPress={() =>
                navigation.navigate("EducationSection", { target: "KafalaFekriya" })
              }
            >
